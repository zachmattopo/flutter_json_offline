...
abstract class AppLocalizations {
  ...
  /// Label for bookmarked posts tab
  ///
  /// In en, this message translates to:
  /// **'Bookmarked'**
  String get bookmarked;

  /// Title for post details page
  ///
  /// In en, this message translates to:
  /// **'Post details'**
  String get postDetails;

  /// Message shown when there are no bookmarked posts
  ///
  /// In en, this message translates to:
  /// **'No bookmarked posts'**
  ...
  /// Tooltip for bookmark button when post is not bookmarked
  ///
  /// In en, this message translates to:
  /// **'Add Bookmark'**
  String get addBookmark;

  /// Tooltip for bookmark button when post is bookmarked
  ///
  /// In en, this message translates to:
  /// **'Remove Bookmark'**
